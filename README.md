...
* **Zero-Dependency Math:** Все алгоритмы конвертации цветов (`RGB ↔ HSL ↔ HEX`) реализованы с нуля. Это позволило избежать лишнего веса бандла (no `colord` / `tinycolor`) и показать понимание алгоритмов.
...
* **Styling:** Tailwind CSS, clsx (для условных классов)
* **Icons:** Lucide React
